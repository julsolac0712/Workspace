<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="TipoAmbito.aspx.vb" Inherits="WorkSpace.TipoAmbito" %>
        ...
        <asp:UpdatePanel ID="upAjax_Usuarios" runat="server">
            <ContentTemplate>
                <span class="page-titles">
                    <asp:Localize ID="lcl_Descripcion" runat="server" Text="Ámbito Geográfico"></asp:Localize>
                </span>
                <div class="margin-top-10 ">
                    <asp:GridView ID="gv_TipoAmbito" runat="server" AutoGenerateColumns="False" CssClass="table table-bordered" DataKeyNames="PK_ID_TipoAmbito,lastUpdate" DataSourceID="sqlDS_TipoAmbito" Width="100%" AllowPaging="True" AllowSorting="True">
                        <Columns>
                    ...
                    <asp:SqlDataSource ID="sqlDS_TipoAmbito" runat="server" ConnectionString="<%$ ConnectionStrings:WSConnectionString %>"
                        SelectCommand="WS_Get_Lista_TipoAmbito" SelectCommandType="StoredProcedure"
                        DeleteCommand="WS_Man_TipoAmbito" DeleteCommandType="StoredProcedure"
                        UpdateCommand="WS_Man_TipoAmbito" UpdateCommandType="StoredProcedure">
                        <DeleteParameters>
