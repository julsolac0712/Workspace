<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="TipoInstrumento.aspx.vb" Inherits="WorkSpace.TipoInstrumento" %>
        ...
        <asp:UpdatePanel ID="upAjax_Usuarios" runat="server">
            <ContentTemplate>
                <span class="page-titles">
                    <asp:Localize ID="lcl_Descripcion" runat="server" Text="Tipo de Instrumento"></asp:Localize>
                </span>
                <div class="margin-top-10 ">
                    <asp:GridView ID="gv_TipoInstrumento" runat="server" AutoGenerateColumns="False" CssClass="table table-bordered" DataKeyNames="PK_ID_TipoInstrumento,lastUpdate" DataSourceID="sqlDS_TipoInstrumento" Width="100%" AllowPaging="True" AllowSorting="True">
                        <Columns>
                    ...
                    <asp:SqlDataSource ID="sqlDS_TipoInstrumento" runat="server" ConnectionString="<%$ ConnectionStrings:WSConnectionString %>"
                        SelectCommand="WS_Get_Lista_TipoInstrumento" SelectCommandType="StoredProcedure"
                        DeleteCommand="WS_Man_TipoInstrumento" DeleteCommandType="StoredProcedure"
                        UpdateCommand="WS_Man_TipoInstrumento" UpdateCommandType="StoredProcedure">
                        <DeleteParameters>
