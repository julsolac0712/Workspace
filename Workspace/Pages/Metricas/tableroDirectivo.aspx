<%@ Page Title="Métricas" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="tableroDirectivo.aspx.vb" Inherits="WorkSpace.tableroDirectivo" %>
    ...
    <div>
        ...
        <asp:SqlDataSource ID="sqlDS_TipoReporte" runat="server" ConnectionString="<%$ ConnectionStrings:WSConnectionString %>" 
                             ...
                             <SelectParameters>
                                 ...
                                 <asp:Parameter DefaultValue="2" Name="FK_ID_TipoReporte" Type="Int32" />
                             </SelectParameters>   
                         </asp:SqlDataSource>
    </div>
</asp:Content>
