<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="TipoExpediente.aspx.vb" Inherits="WorkSpace.TipoExpediente" %>
        ...
        <asp:UpdatePanel ID="upAjax_Usuarios" runat="server">
            <ContentTemplate>
                <span class="page-titles">
                    <asp:Localize ID="lcl_Descripcion" runat="server" Text="Tipo de Expediente"></asp:Localize>
                </span>
                <div class="margin-top-10 ">
                    <asp:GridView ID="gv_TipoExpediente" runat="server" AutoGenerateColumns="False" CssClass="table table-bordered" DataKeyNames="PK_ID_TipoExpediente,lastUpdate" DataSourceID="sqlDS_TipoExpediente" Width="100%" AllowPaging="True" AllowSorting="True">
                        <Columns>
                    ...
                    <asp:SqlDataSource ID="sqlDS_TipoExpediente" runat="server" ConnectionString="<%$ ConnectionStrings:WSConnectionString %>"
                        ...
                        DeleteCommand="WS_Man_TipoExpediente" DeleteCommandType="StoredProcedure"
                        UpdateCommand="WS_Man_TipoExpediente" UpdateCommandType="StoredProcedure">
                        <DeleteParameters>
