<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="TipoTema.aspx.vb" Inherits="WorkSpace.TipoTema" %>
        ...
        <asp:UpdatePanel ID="upAjax_Usuarios" runat="server">
            <ContentTemplate>
                <span class="page-titles">
                    <asp:Localize ID="lcl_Descripcion" runat="server" Text="Temas"></asp:Localize>
                </span>
                <div class="margin-top-10 ">
                    <asp:GridView ID="gv_TipoTema" runat="server" AutoGenerateColumns="False" CssClass="table table-bordered" DataKeyNames="PK_ID_TipoTema,lastUpdate" DataSourceID="sqlDS_TipoTema" Width="100%" AllowPaging="True" AllowSorting="True">
                        <Columns>
                    ...
                    <asp:SqlDataSource ID="sqlDS_TipoTema" runat="server" ConnectionString="<%$ ConnectionStrings:WSConnectionString %>"
                        SelectCommand="WS_Get_Lista_TipoTemas" SelectCommandType="StoredProcedure"
                        DeleteCommand="WS_Man_TipoTema" DeleteCommandType="StoredProcedure"
                        UpdateCommand="WS_Man_TipoTema" UpdateCommandType="StoredProcedure">
                        <DeleteParameters>
