<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/SiteEmbed.Master" CodeBehind="FormularioInstrumentos.aspx.vb" Inherits="WorkSpace.FormularioInstrumentos" %>
            ...
            <div id="exTab2" class="container margin-top-30">
                <ul class="nav nav-tabs">
                    ...
                    <li><a href="#1" data-toggle="tab">
                        <asp:Localize ID="lcl_PaisesInvolucrados" runat="server" Text="Países Involucrados"></asp:Localize></a>
                    </li>
